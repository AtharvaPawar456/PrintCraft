...
from utils import listFileinFolder, display_all_content, display_10percent_file_content
...
# servoCods = 'servo_coordinates_OBJ_gcode.txt'
# servoCods = "uploads\setup\servoCords.txt"
servoCods = "uploads/setup/servoCords.txt"

# https://printcraft.atharvapawar.repl.co/servoCords.txt
@app.route('/servoCords.txt')
def get_servo_coordinates():
  try:
